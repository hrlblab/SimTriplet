...
def get_dataset(dataset, data_dir, img_name_file, transform, train=True, download=False, debug_subset_size=None):
    if dataset == 'mnist':
        ...
        dataset = RandomDataset(data_dir, img_name_file, train=train, transform=transform)
    else:
